...
vtkStandardNewMacro(vtkRoiBalloonWidget);
...
//-------------------------------------------------------------------------
vtkRoiBalloonWidget::vtkRoiBalloonWidget(){}

//-------------------------------------------------------------------------
vtkRoiBalloonWidget::~vtkRoiBalloonWidget(){}

//-------------------------------------------------------------------------
int vtkRoiBalloonWidget::SubclassHoverAction()
{
  double e[2];
...
//-------------------------------------------------------------------------
int vtkRoiBalloonWidget::SubclassEndHoverAction()
{
  double e[2];
  e[0] = static_cast<double>(this->Interactor->GetEventPosition()[0]);
  e[1] = static_cast<double>(this->Interactor->GetEventPosition()[1]);
...
void vtkRoiBalloonWidget::AttachToRightNode(vtkContourRepresentation * contourRep)
{
