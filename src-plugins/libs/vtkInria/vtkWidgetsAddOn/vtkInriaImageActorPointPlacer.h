/*=========================================================================
  ...
  Module:    vtkInriaImageActorPointPlacer.h
...
=========================================================================*/
// .NAME vtkInriaImageActorPointPlacer - Converts 2D display positions to world positions such that they lie on an ImageActor
// .SECTION Description
...
#ifndef __vtkInriaImageActorPointPlacer_h
#define __vtkInriaImageActorPointPlacer_h
...
class VTK_WIDGETSADDON_EXPORT vtkInriaImageActorPointPlacer : public vtkPointPlacer
{
public:
  // Description:
  // Instantiate this class.
  static vtkInriaImageActorPointPlacer *New();

  // Description:
  // Standard methods for instances of this class.
  vtkTypeMacro(vtkInriaImageActorPointPlacer,vtkPointPlacer);
...
private:
  vtkInriaImageActorPointPlacer(const vtkInriaImageActorPointPlacer&);  //Not implemented
  void operator=(const vtkInriaImageActorPointPlacer&);  //Not implemented
};
