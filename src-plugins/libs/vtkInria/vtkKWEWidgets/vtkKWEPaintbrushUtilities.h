...
// Verbosity requires VTK_LEAN_AND_MEAN to be OFF and 
// VTK_PAINTBRUSH_VERBOSE_MODE to be ON
#ifdef VTK_LEAN_AND_MEAN
//#  define VTK_PAINTBRUSH_VERBOSE_MODE
#endif

#ifndef VTK_PAINTBRUSH_VERBOSE_MODE
# define vtkKWEPaintbrushVerboseStreamMacro(x, os)
#else
#  define vtkKWEPaintbrushVerboseStreamMacro(x, os) \
   { \
   os << x ; \
...
#define vtkKWEPaintbrushVerboseMacro(x) \
  vtkKWEPaintbrushVerboseStreamMacro(x, std::cout)
