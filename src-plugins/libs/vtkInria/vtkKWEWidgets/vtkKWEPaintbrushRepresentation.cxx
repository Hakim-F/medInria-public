...
vtkCxxRevisionMacro(vtkKWEPaintbrushRepresentation, "$Revision: 3605 $");
vtkCxxSetObjectMacro(vtkKWEPaintbrushRepresentation, ShapePlacer, vtkPointPlacer);

int vtkKWEPaintbrushRepresentation::SingleSliceThickBrushDefault = 0;
...
vtkKWEPaintbrushRepresentation::vtkKWEPaintbrushRepresentation()
{
  ...
  this->SingleSliceThickBrush = vtkKWEPaintbrushRepresentation::SingleSliceThickBrushDefault;
}
...
::RemoveSketch( vtkKWEPaintbrushSketch * sketch )
{
  ...
  this->PaintbrushDrawing->Modified();
...
//----------------------------------------------------------------------
int vtkKWEPaintbrushRepresentation::AddShapeToCurrentStroke( double p[3] )
{
  return this->PaintbrushDrawing->AddShapeToCurrentStroke( this->SketchIndex, p );
}
