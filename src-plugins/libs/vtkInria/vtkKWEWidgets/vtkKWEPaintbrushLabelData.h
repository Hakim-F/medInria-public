...
public:
  ...
  // Description:
  // Do not call directly to replace a label in a drawing. Use
  // vtkKWEPaintbrushSketch::SetLabel if this data is already associated
  // with a sketch in a drawing.
  // This method Replaces voxels with label of "from" to the value "to".
  virtual void ReplaceLabel(
