...
vtkCxxRevisionMacro(vtkKWEPaintbrushGrayscaleData, "$Revision: 3597 $");
...
//----------------------------------------------------------------------------
void vtkKWEPaintbrushGrayscaleData::GetSpacing( double s[3] )
{
  this->ImageData->GetSpacing(s);
}
...
//----------------------------------------------------------------------------
void vtkKWEPaintbrushGrayscaleData::GetOrigin( double s[3] )
{
  this->ImageData->GetOrigin(s);
}
