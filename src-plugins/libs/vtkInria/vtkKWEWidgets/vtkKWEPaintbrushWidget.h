...
#include "vtkKWEWidgetsExport.h" // needed for export symbol directives
...
protected:
  ...
  // Description:
  // The internal method is the same except that it invokes the method
  // without generating an event
  int ToggleSelectStateActionInternal( vtkKWEPaintbrushWidget *dispatcher);
