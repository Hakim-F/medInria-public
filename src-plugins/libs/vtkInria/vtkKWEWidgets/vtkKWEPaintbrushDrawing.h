...
protected:
  ...
  // A return value of 0 indicates that there was no change to the sketch.
  // This is used upstream to speed up interaction (avoid re-renders).
  virtual int AddShapeToCurrentStroke( int n, double p[3] );
