...
public:
  ...
  // Description:
  // Method for turning on/off event processing for all widgets in the group.
  ...
  // Description:
  // Render all widgets during interaction. ON by default. If off, the
  // view being interacted with is rendered more frequently during interaction.
  // The other views are updated as soon as interaction ends or less
  // frequently during interaction.
  vtkSetMacro( InteractiveRenderAllWidgets, int );
  vtkGetMacro( InteractiveRenderAllWidgets, int );
  vtkBooleanMacro( InteractiveRenderAllWidgets, int );

  // Description:
  // Set a name/description for this widget group (optional)
...
protected:
  ...
  int InteractiveRenderAllWidgets;
  char *Description;
