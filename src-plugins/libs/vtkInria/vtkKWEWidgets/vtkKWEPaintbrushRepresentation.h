...
public:
  ...
  // trace. A return value of 0 indicates that the stroke did not change
  // as a result of this shape addition. This may be used for speedups
  // by avoiding re-renders.
  virtual int AddShapeToCurrentStroke( double p[3] );
